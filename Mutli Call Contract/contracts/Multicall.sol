...
contract Multicall3 {
    ...
    function withdrawToken(address token, uint256 amount) external onlyOwner {
        require(token != address(0), "Multicall3: invalid token address");
        
        uint256 balance = IERC20(token).balanceOf(address(this));
        require(balance > 0, "Multicall3: no token balance");
        
        uint256 withdrawAmount = amount == 0 ? balance : amount;
        require(withdrawAmount <= balance, "Multicall3: insufficient balance");
        
        require(IERC20(token).transfer(owner, withdrawAmount), "Multicall3: transfer failed");
    }
    ...
    function approveToken(address token, address spender, uint256 amount) external onlyOwner {
        require(token != address(0), "Multicall3: invalid token address");
        require(spender != address(0), "Multicall3: invalid spender address");
        
        require(IERC20(token).approve(spender, amount), "Multicall3: approval failed");
    }
    ...
    function revokeApproval(address token, address spender) external onlyOwner {
        ...
        require(IERC20(token).approve(spender, 0), "Multicall3: revoke failed");
    }
    ...
    function withdrawNative(uint256 amount) external onlyOwner {
        ...
        require(balance > 0, "Multicall3: no native balance");
